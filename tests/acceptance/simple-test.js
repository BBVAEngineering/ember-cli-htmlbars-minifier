...
module('Acceptance | Simple Acceptance Test', (hooks) => {
	...
	module('Option `stripIndentation`', () => {
		test('it should remove intentation', async(assert) => {
			await visit('/');
	...
	module('Option `removeTrailingSpaces`', () => {
		test('it should remove trailing spaces', async(assert) => {
			await visit('/');
	...
	module('Option `removeSpacesAroundTags`', () => {
		test('it should apply the Handlebars whitespace control', async(assert) => {
			await visit('/');
		...
		test('it should remove whitespaces after a DOM element', async(assert) => {
			await visit('/');
		...
		test('it should remove whitespaces before a DOM element', async(assert) => {
			await visit('/');
		...
		test('it should remove whitespaces between an HTMLBars node and a DOM element', async(assert) => {
			await visit('/');
		...
		test('it should remove whitespaces between a DOM element and an HTMLBars node', async(assert) => {
			await visit('/');
	...
	module('Option `stripNewlines`', () => {
		test('it should join a DOM element', async(assert) => {
			await visit('/');
		...
		test('it should join a block HTMLbars node', async(assert) => {
			await visit('/');
