...
function HtmlbarsMinifier(inputNode, options) {
	if (!(this instanceof HtmlbarsMinifier)) {
		return new HtmlbarsMinifier(inputNode, options);
	}

	this.options = Object.assign(options || {}, { persist: true });
...
HtmlbarsMinifier.prototype.cacheKeyProcessString = function(string, relativePath) {
